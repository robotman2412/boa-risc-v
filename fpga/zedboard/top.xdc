...
create_clock -name clk -period 40 [get_nets {clk}]

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {pmod_a0}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {pmod_a1}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {pmod_a2}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {pmod_a3}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {pmod_a4}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {pmod_a5}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {pmod_a6}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {pmod_a7}];  # "JA10"
